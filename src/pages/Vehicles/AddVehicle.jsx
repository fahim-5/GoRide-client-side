    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 flex items-center justify-center">
        <div className="text-center bg-white rounded-2xl shadow-xl p-8 max-w-md mx-4">
          ...
          <p className="text-gray-600 mb-6">Please login to add a vehicle to our platform.</p>
          <button
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-green-600 to-green-700 px-6 py-5">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                ...
                <button
                  ...
                  className="bg-white/20 text-white px-5 py-2.5 rounded-xl hover:bg-white/30 transition-all duration-200 font-medium border border-white/30 backdrop-blur-sm flex items-center space-x-2 self-start"
                >
            ...
            <div className="border-t border-gray-100 bg-gray-50 px-6 py-5">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-800 mb-2">Listing Tips</h4>
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200">
              ...
              <h3 className="font-bold text-gray-800 mb-2">Earn Money</h3>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 border border-purple-200">
              ...
              <h3 className="font-bold text-gray-800 mb-2">Trusted Community</h3>
              <p className="text-gray-600 text-sm">
          ...
          <div className="mt-8 bg-white rounded-2xl p-6 border border-gray-200 text-center">
            <h3 className="font-semibold text-gray-800 mb-2">Need Help Listing Your Vehicle?</h3>
            <p className="text-gray-600 text-sm mb-4">
              Our support team is here to help you create the perfect listing.
            </p>
            <button className="text-blue-600 hover:text-blue-700 font-medium text-sm flex items-center justify-center space-x-1 mx-auto">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
