...
const MyVehicles = () => {
  ...
  const { getMyVehicles, deleteVehicle, updateVehicle, loading } = useVehicles(); // ✅ ADDED updateVehicle
    ...
    const fetchVehicles = async () => {
      if (user) {
        try {
          ...
          // ✅ SAFE DATA PROCESSING: Handle all possible response formats
          let vehiclesArray = [];
          ...
          if (Array.isArray(response)) {
            ...
            // Case 4: Unexpected format or empty
  ...
  const handleUpdateVehicle = async (vehicleId) => {
    ...
    try {
      // First, let's verify the vehicle exists and user has access
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 flex items-center justify-center">
        <div className="text-center">
          <LoadingSpinner />
          <p className="mt-4 text-gray-600 text-lg">Loading your vehicles...</p>
        </div>
      </div>
    );
  }
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                  <div className="mb-4 sm:mb-0">
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">Filter Vehicles</h3>
                    <p className="text-gray-600 text-sm">Show vehicles based on availability</p>
                  </div>
                    ...
                    >
                      ...
                      <div className="p-6">
                        <div className="flex justify-between items-start mb-3">
                          ...
                          <span className="bg-blue-100 text-blue-600 px-2 py-1 rounded text-sm font-medium whitespace-nowrap flex-shrink-0">
